...
class _VetsScreenState extends State<VetsScreen> {
  final String _currentLocation = 'Nakuru, Kenya';
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: PopupMenuButton<String>(
                    onSelected: (value) => _startConsultation(value),
                    itemBuilder: (context) => [
                      const PopupMenuItem(
                        value: 'video',
                        child: Row(
                          children: [
                            Icon(Icons.videocam, color: Color(0xFF2E7D32)),
                            SizedBox(width: 8),
                            Text('Video Call'),
                          ],
                        ),
  ...
  void _startConsultation(String consultationType) {
